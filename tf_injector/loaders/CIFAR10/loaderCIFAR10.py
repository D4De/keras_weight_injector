...
def np_preprocessed_dataset():
    ...
    # Converti a array numpy e passa separatamente a from_tensor_slices
...
def tf_preprocessed_dataset():
    ...
    # Definisci la funzione di preprocessing
    def preprocess_image(image, label):
        ...
        # Converti a float32 e normalizza [0-255] -> [0-1]
    ...
    # Applica la funzione di preprocessing a tutto il dataset
