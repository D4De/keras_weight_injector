...
# from path_to_tf_injector/keras_tf_injector/datset_loaders/GTSRBnp/loaderGTSRB.py (__file__)
# to path_to_tf_injector/keras_tf_injector/datset_loaders/dataset (default dataset path)
